...
<template>
  <div class="page">
    ...
    <main class="main">
      ...
      <section v-if="projects.loaded && projects.projects.length === 0" class="hero">
      ...
      <template v-if="projects.loaded && projects.projects.length > 0">
        <div class="page-header">
          <h2 class="page-title">Projects</h2>
          <div class="muted page-count">{{ projects.projects.length }} total</div>
        </div>
