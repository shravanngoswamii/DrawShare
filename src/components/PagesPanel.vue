      ...
      <div class="panel-head">
        ...
        <div class="head-menu-wrap">
          ...
          <div v-if="menuOpen" class="head-menu" role="menu">
            <button class="head-menu-item" role="menuitem" @click="settingsOpen = true; menuOpen = false">
            ...
            <button class="head-menu-item" role="menuitem" @click="emit('zen'); menuOpen = false">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                <path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7z" /><line x1="4" y1="20" x2="20" y2="4" />
              </svg>
              <span>Zen mode</span>
            </button>
